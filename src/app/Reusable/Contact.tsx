      ...
      <section className="p-2 lg:p-20 flex items-center justify-center w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 md:gap-24 p-0 md:p-4 w-full px-4 lg:px-0 ">
          ...
          <div className="md:col-start-2 row-span-2 flex-col mt-20 md:mt-0 ">
            <h3 className="text-2xl md:text-[32px] lg:text-[32px] xl:text-[32px] text-[#333333] font-semibold mb-0 sm:mb-10 text-start">
              Leave A Message
            </h3>
            <ContactForm />
          </div>

          {/* Grid Item 3: Contains BOTH Contact Details and Social Icons */}
          <div className="md:row-span-1 flex-col">
            ...
            {/* Sub-item: Social Icons - MOVED TO BE INSIDE THE PARENT GRID ITEM */}
            <div className="mt-10">
              <div className="hidden sm:flex space-x-4">
                ...
                >
                  ...
                  />
                  <path
                    d="M21.875 8.13875L21.8875 8.125"
                    stroke="#1A1A1A"
                    strokeWidth="1.5"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                ...
                >
                  <path
                    d="M15 11.9375C16.1462 10.7663 17.6388 10 19.375 10C21.1984 10 22.947 10.7243 24.2364 12.0136C25.5257 13.303 26.25 15.0516 26.25 16.875V26.25H23.75V16.875C23.75 15.7147 23.2891 14.6019 22.4686 13.7814C21.6481 12.9609 20.5353 12.5 19.375 12.5C18.2147 12.5 17.1019 12.9609 16.2814 13.7814C15.4609 14.6019 15 15.7147 15 16.875V26.25H12.5V10.625H15V11.9375ZM6.25 8.125C5.75272 8.125 5.27581 7.92746 4.92417 7.57583C4.57254 7.22419 4.375 6.74728 4.375 6.25C4.375 5.75272 4.57254 5.27581 4.92417 4.92417C5.27581 4.57254 5.75272 4.375 6.25 4.375C6.74728 4.375 7.22419 4.57254 7.57583 4.92417C7.92746 5.27581 8.125 5.75272 8.125 6.25C8.125 6.74728 7.92746 7.22419 7.57583 7.57583C7.22419 7.92746 6.74728 8.125 6.25 8.125ZM5 10.625H7.5V26.25H5V10.625Z"
                    fill="#1A1A1A"
                  />
                </svg>
              </div>
