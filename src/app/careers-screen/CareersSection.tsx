      ...
      <div className="container mx-auto px-6 mb-4 ">
        ...
        <div className=' mb-10'>
          <motion.h2
            ...
            className="text-[24px] md:text-5xl xl:text-[48px] font-[600] text-gray-900"
          >
            Careers
          </motion.h2>
          <motion.p
            ...
            className="text-[#808080] text-[14px] md:text-[18px] font-[400] mt-2"
          >
          ...
          <motion.p
            ...
            animate={inView ? { opacity: 1, y: 0 } : { opacity: 0, y: 30 }}
            transition={{ duration: 0.6, ease: "easeInOut", delay: 1.0 }}
            className="text-[#808080] text-[14px] md:text-[18px] font-[500] ">
            One Block At A Time!
          </motion.p>
